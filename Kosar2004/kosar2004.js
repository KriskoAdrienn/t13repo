...
function AdatFeltolto(feltoltendoElem) {
...
var kosarAdatok = AdatFeltolto(eredmenyek);
console.log(kosarAdatok);
//3. feladat
function RealMadrid(vizsgaltTomb) {
    var hazaiMerkozes = 0;
    var idegenMerkozes = 0;
...
//4. feladat
function dontetlenMerkozes(vizsgaltTomb) {
...
function Noveber2004Kiir(kiirandoEredmenyek) {
...
function stadionStatisztika(vizsgaltTomb) {
    var statisztikaAdat = [];
    for (var i = 0; i < vizsgaltTomb.length; i++) {
        var szerepelE = false;
        var adottIndex = 0;
        for (var j = 0; j < statisztikaAdat.length; j++) {
        ...
        if (!szerepelE) {
            var ujStadion = { stadionNeve: vizsgaltTomb[i].helyszin, merkozesSzam: 1 };
...
function stadionStatisztikaKiir(eredmenyObjektum) {
